...
export const copy = {
  ...
  fa: {
    ...
    intro:
      "من یاسمنم؛ توسعه‌دهنده‌ای با تمرکز بر فرانت‌اند که میان رابط‌های فکرشده و روایت بصری، مسیر خودش را پیدا می‌کند.",
    ...
    aboutText:
      "من یاسمنم، دانشجوی مهندسی کامپیوتر در تهران. از HTML و CSS شروع کردم و سؤال‌ها را دنبال کردم: یک کامپوننت چطور کار می‌کند؟ در سرور چه می‌گذرد؟ چطور یک رابط کاربری حس بهتری می‌دهد؟",
    aboutText2:
    ...
    formNote:
      "پیام شما به‌صورت خصوصی برای یاسمن ذخیره می‌شود. برای ارتباط مستقیم می‌توانید از ایمیل کنار فرم استفاده کنید.",
    privacy: "حریم خصوصی",
    terms: "شرایط استفاده",
